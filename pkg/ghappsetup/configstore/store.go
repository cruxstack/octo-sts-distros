...
// Environment variable names for GitHub App credentials.
const (
...
// The struct mirrors the GitHub API response from app manifest conversion.
type AppCredentials struct {
	// Fields from GitHub API response
	AppID         int64      `json:"id"`
	...
	// CustomFields allows apps to store additional app-specific values.
	// These are persisted alongside the GitHub credentials.
	// Keys should be valid environment variable names (e.g., "STS_DOMAIN").
